...
QT_MOC_LITERAL(1, 12, 21), // "on_clicked_pushButton"
QT_MOC_LITERAL(2, 34, 0) // ""

    },
    "lightWindow\0on_clicked_pushButton\0"
};
...
void lightWindow::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        auto *_t = static_cast<lightWindow *>(_o);
        Q_UNUSED(_t)
        switch (_id) {
        case 0: _t->on_clicked_pushButton(); break;
        default: ;
        }
    }
    Q_UNUSED(_a);
...
QT_INIT_METAOBJECT const QMetaObject lightWindow::staticMetaObject = { {
    &QWidget::staticMetaObject,
    qt_meta_stringdata_lightWindow.data,
    qt_meta_data_lightWindow,
    qt_static_metacall,
    nullptr,
    nullptr
} };
...
void *lightWindow::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, "Ui::lightWindow"))
        return static_cast< Ui::lightWindow*>(this);
