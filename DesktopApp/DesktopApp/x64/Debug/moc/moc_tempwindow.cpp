...
#define QT_MOC_LITERAL(idx, ofs, len) \
    ...
    qptrdiff(offsetof(qt_meta_stringdata_tempWindow_t, stringdata0) + ofs \
        - idx * sizeof(QByteArrayData)) \
    )
static const qt_meta_stringdata_tempWindow_t qt_meta_stringdata_tempWindow = {
    {
QT_MOC_LITERAL(0, 0, 10), // "tempWindow"
QT_MOC_LITERAL(1, 11, 24), // "on_clicked_refreshButton"
QT_MOC_LITERAL(2, 36, 0) // ""

    },
    "tempWindow\0on_clicked_refreshButton\0"
    ""
};
#undef QT_MOC_LITERAL

static const uint qt_meta_data_tempWindow[] = {
...
void tempWindow::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        Q_UNUSED(_t)
        switch (_id) {
        case 0: _t->on_clicked_refreshButton(); break;
        default: ;
        }
    }
    Q_UNUSED(_a);
...
QT_INIT_METAOBJECT const QMetaObject tempWindow::staticMetaObject = { {
    &QWidget::staticMetaObject,
    qt_meta_stringdata_tempWindow.data,
...
void *tempWindow::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, "Ui::tempWindow"))
        return static_cast< Ui::tempWindow*>(this);
